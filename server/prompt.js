...
async function user_prompt(task, is_regenerate) {
    ...
    let prompt = `
                Imagine you are the manager of a team, break down the task ${task}. Make these tasks small, specific and easy to manage almost as if they were steps that the member could follow. Please be as specific as possible.
